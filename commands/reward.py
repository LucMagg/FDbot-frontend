...
###### VUES DES CHOIX
    def __init__(self, outer, selectable_choices):
      ...
      for choice in self.selectable_choices:
        ...
        self.add_item(self.outer.ChoiceButton(outer=self.outer, icon=icon, label=label, grade=grade, has_quantity=has_quantity, is_selected=is_selected))     
...
##### COMMANDE
  ...
  async def initial_view_with_multiple_choices(self, interaction: discord.Interaction):
    ...
    self.view = self.ChoiceView(self, selectable_choices=choices)
